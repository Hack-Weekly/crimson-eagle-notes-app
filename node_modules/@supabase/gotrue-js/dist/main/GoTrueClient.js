...
class GoTrueClient {
    ...
    async _initialize() {
        ...
        this.initializePromise = this._acquireLock(-1, async () => await (0, helpers_1.stackGuard)('_initialize', async () => {
            try {
    ...
    async _acquireLock(acquireTimeout, fn) {
        ...
        try {
            if (!(await (0, helpers_1.stackGuardsSupported)())) {
            ...
            if ((0, helpers_1.isInStackGuard)('_acquireLock')) {
            ...
            return await this.lock(`lock:${this.storageKey}`, acquireTimeout, async () => {
                ...
                try {
                    return await (0, helpers_1.stackGuard)('_acquireLock', async () => {
                        return await fn();
                    });
                }
                finally {
    ...
    async _useSession(fn) {
        ...
        try {
            if ((0, helpers_1.isInStackGuard)('_useSession')) {
    ...
    async __loadSession() {
        ...
        if (this.logDebugMessages && !(0, helpers_1.isInStackGuard)('_useSession') && (await (0, helpers_1.stackGuardsSupported)())) {
