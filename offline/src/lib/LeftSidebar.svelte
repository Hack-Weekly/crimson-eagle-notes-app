...
<!-- left items -->
<div
	class="hidden md:flex flex-col justify-between items-center fixed top-0 bottom-0 left-0 w-32 py-12 border-r border-slate-700"
>
	<div id="add" class="mx-auto relative">
		<button
